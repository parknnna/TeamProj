...
<div class="container" align="center" style="width:80%;">
	<div class="map_wrap" style="width:60%;display:inline-block;float:right;position:relative">
	    <div id="map" style="width:100%;height:100%;position:relative;" ></div>
	</div>
	
    <div id="menu_wrap" class="bg_white" style="width:40%;height:500px;position:relative;float:left;display:inline-block;">
        <div class="option">
...
<div class="infoApi" align="center" style="margin-top:530px; position:relative;">
<div align="left" style="width:80%; margin:90px auto 2px auto;">
	<%
		if(pname!=null){
			
	%>
		<h3 style="font-family: 'Do Hyeon', sans-serif;"><i class="fas fa-search fa-sm"></i>  <%=pname %> 검색 결과 더보기</h3>
		<%} %>
	</div>
<%  
int cnt=0;
int p=5;
int display = 7; // 검색결과갯수. 최대100개  
try { 
   ...
   if(cnt==0){
      ...
      <div class="childInfo" style="width:60%;text-align:center;"><table class="infoTable" style="width:100%;"><%
   }
   if(0==cnt || cnt==5 ){
   }else{
      String a[]=line.split(":");
      ...
      for(int i=0;i<a.length;i++){
         ...
         if(p==1){%><a href="<%=a[2]%>"><%}
         if(p==2){%><font style="color:#c4c4c4"><%}
         
         if(i>0){
            if(p==1){
               if(i>1) continue;
               %><i class="far fa-hand-point-right"></i>  <font class="linktag">페이지로 이동</font><%
            }else{
