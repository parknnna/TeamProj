...
<div align = "center">
   <form name = "f" action = "member_edit_ok_resv.do?mode=mypage" method = "post" enctype="multipart/form-data">
      ...
      <table class = "outline" border = "1">
         ...
         <tr>
            <td colspan = "4" align = "center">
               ...
               <input type="button" value="회원탈퇴" style = "width : 80px;" onclick="window.location='member_delete_resv.do'">
            </td>
         </tr>
      </table>
   </form>
