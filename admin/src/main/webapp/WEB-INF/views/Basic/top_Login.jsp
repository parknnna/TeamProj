...
<%@ include file="head.jsp" %>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      ...
      <div class="header-btns" id="ftco-nav">
      	<ul class="navbar-nav">
      	<li class="nav-item cta"><a href="member_login.do" class="nav-link"><span style="font-weight:800;">Login</span></a>
      		<ul class="submenu">
  ...
  <div class="hero-wrap js-fullheight"
		style="background-image: url('${pageContext.request.contextPath}/resources/images/login_img.jpg'); height:70%;">
		<div class="container">
			<div
				...
				<div class="col-md-9-1 ftco-animate text-center"
					...
					<p class="breadcrumbs"
						...
						<span class="mr-2"><a href="index">Home</a></span> <span>Login</span>
					</p>
					<h1 class="mb-3 bread"
						data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Let's Travel Together!</h1>
				</div>
			</div>
		</div>
	</div>