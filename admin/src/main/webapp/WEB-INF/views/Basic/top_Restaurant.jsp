...
<%@ include file="head.jsp" %>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
         <li class="nav-item"><a href="index" class="nav-link">Home</a></li>
          ...
          <li class="nav-item active"><a href="restaurant_main.do" class="nav-link">Restaurant</a></li>
  ...
  <div class="hero-wrap js-fullheight"
		style="background-image: url('${pageContext.request.contextPath}/resources/images/restaurant-3.jpg'); height:70%;">
		<div class="container">
			<div
				...
				<div class="col-md-9-1 ftco-animate text-center"
					...
					<p class="breadcrumbs"
						...
						<span class="mr-2"><a href="index">Home</a></span> <span>Restaurant</span>
					</p>
					<h1 class="mb-3 bread"
						data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Restaurant</h1>
				</div>
			</div>
		</div>
	</div>