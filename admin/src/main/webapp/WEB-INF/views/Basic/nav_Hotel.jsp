    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="hotel_main.do" class="nav-link-1">Hotels</a></li>
      ...
      <div class="header-btns" id="ftco-nav">
      	...
      	<li class="nav-item cta"><a href="member_login.do" class="nav-link"><span>Login</span></a>
      		<ul class="submenu">
                ...
                <li><a href="member_input.do" class="submenu-1-third" style="color:black">Sign Up</a></li>
      		</ul>
      	</li>
      	</ul>
      </div>
