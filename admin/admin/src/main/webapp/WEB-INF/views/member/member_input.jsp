...
<article class="card-body">
	<form name = "f" action = "member_input_ok.do" method = "post" style="width:80%;"  enctype="multipart/form-data">
				...
				<div class="form-wrap">
					...
					<div class="id">
						<input type = "text" style="margin-bottom:1px" class="form-control"  name = "id" id = "id">
						<input type = "button" style="padding:3px;font-size:12px;float:right;background:#e9e9e9;border:1px solid #fff;border-radius:5px;" value = "중복체크" onClick = "javascript:checkId()">
					</div>
				</div>
