...
<div align = "center" style="margin-top:30px;margin-bottom:20px;">
   <form name = "f" action = "member_edit_ok.do?mode=mypage" method = "post" enctype="multipart/form-data">
      ...
      <table class = "outline" border = "1" style="width:60%">
         <tr>
            <td rowspan = "4" align = "center">
               <img src="${pageContext.request.contextPath}/resources/img/${sedto.filename}" width = "100" height = "100">
            </td>
         </tr>
         <tr>
            <th align = "center">이름</th>
            <td><input type = "text" value = "${sedto.name}" size = "10" disabled style="width:120px;"></td>
         </tr>
         <tr>
            <th align = "center">아이디</th>
            <td><input type = "text" name = "id" value = "${sedto.id}" size = "10" disabled style="width:120px;"></td>
         </tr>
         <tr>
            <th align = "center">비밀번호</th>
            <td><input type = "password" name = "passwd" size = "10" style="width:120px;"></td>
         </tr>
         <tr>
