...
<div align="center" style="margin-top:10px">
	<table width="60%">
		<tr align="right">
			<th class="asd">${dto.name} 호텔의 정보</th>
			<td><a href="hotel_board_list.do?hotel_no=${dto.hotel_no }">게시판 이동  </a><a href="javascript:history.go(-1)" >뒤로가기</a></td>
		</tr>
		<tr align="center" >
			<td class="asd">호텔번호</td><td>${dto.hotel_no}</td>
		</tr>
		<tr align="center" >
			<td class="asd">호텔주소</td><td>${dto.address}</td>
		</tr>
		<tr align="center" >
			<td class="asd">전화번호</td><td>${dto.hp1} - ${dto.hp2} - ${dto.hp3}</td>
		</tr>
		<tr align="center">
			<td class="asd">등급</td>
			<td>
		...
		<tr align="center">
			<td class="asd">호텔정보</td><td>${dto.hotel_info }</td>
		</tr>
