    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate">
            ...
            <h2 class="mb-4"><strong>User</strong> Forum</h2>
          </div>
        </div>    		
    	</div>
    	<div class="container-fluid">
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate">
            ...
            <h2 class="mb-4"><strong>Hotel</strong> Review</h2>
          </div>
        </div>    		
    	</div>
    	<div class="container-fluid">
    			...
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="destination">
    					...
    					<div class="text p-3">
    						<div class="d-flex">
    							<div class="one">
		    						<h3><a href="hotel_content.do?hotel_board_no=<%=dto.getHotel_board_no() %>&hotel_no=<%=dto.getHotel_no() %>"><%=dto.getTitle() %></a></h3>
	    						</div>		
		    					<div class="two">
